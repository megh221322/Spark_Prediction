...
public class WineQualityEvaluation {
    public static void main(String[] args) throws IOException {
        ...
        LogisticRegressionModel logisticModel = LogisticRegressionModel.load("file:///home/hadoop/WineQualityPredictionModel");
        ...
        Dataset<Row> validationData = spark.read()
                ...
                .option("delimiter", ";")
                .csv("file:///home/hadoop/ValidationDataset.csv");
        ...
        Dataset<Row> predictions = logisticModel.transform(featureData);
        ...
        // Show predictions
        predictions.select("quality", "prediction", "probability")
                .show();
